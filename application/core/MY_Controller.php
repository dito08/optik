...
class CMS_Controller extends MX_Controller
{
     ...
     */
    protected function cms_do_register($username, $email, $first_name, $last_name, $password)
    {
        return $this->No_CMS_Model->cms_do_register($username, $email, $first_name, $last_name, $password);
    }
     ...
     */
    protected function cms_do_change_profile($user_name, $email, $first_name, $last_name, $password = NULL)
    {
        return $this->No_CMS_Model->cms_do_change_profile($user_name, $email, $first_name, $last_name, $password);
    }
     ...
     * @desc    change current profile (user_name, email, real_name and password)
     */
    protected function cms_do_change_address($user_name, $first_name, $last_name, $company=NULL, $handphone=NULL, $telephone=NULL, $address=NULL, $city=NULL, $state=NULL, $postal_code=NULL, $country=NULL)
    {
        return $this->No_CMS_Model->cms_do_change_address($user_name, $first_name, $last_name, $company, $handphone, $telephone, $address, $city, $state, $postal_code, $country);
    }
    ...
    public function cms_ecommerce_order($user_id)
    {
        return $this->No_CMS_Model->cms_ecommerce_order($user_id);
    }

    public function cms_do_save_order($order_id,$data,$detail)
    {
        return $this->No_CMS_Model->cms_do_save_order($order_id,$data,$detail);
    }

    public function cms_ecommerce_order_detail($order_no)
    {
        return $this->No_CMS_Model->cms_ecommerce_order_detail($order_no);
    }

    public function cms_ecommerce_order_info($order_no)
    {
        return $this->No_CMS_Model->cms_ecommerce_order_info($order_no);
    }

    public function cms_ecommerce_wishlist($user_id)
    {
        return $this->No_CMS_Model->cms_ecommerce_wishlist($user_id);
    }

    public function cms_ecommerce_have_buy($user_id=NULL,$product_id=NULL)
    {
        return $this->No_CMS_Model->cms_ecommerce_have_buy($user_id,$product_id);
    }

    public function cms_ecommerce_product($category=NULL,$limit=NULL)
    {
        return $this->No_CMS_Model->cms_ecommerce_product($category,$limit);
    }

    public function cms_ecommerce_product_detail($id)
    {
        return $this->No_CMS_Model->cms_ecommerce_product_detail($id);
    }

    public function cms_ecommerce_product_cart($id)
    {
        return $this->No_CMS_Model->cms_ecommerce_product_cart($id);
    }

    public function cms_ecommerce_add_wishlist($product_id,$user_id,$qty)
    {
        return $this->No_CMS_Model->cms_ecommerce_add_wishlist($product_id,$user_id,$qty);
    }

    public function cms_ecommerce_remove_wishlist($wishlist_id)
    {
        return $this->No_CMS_Model->cms_ecommerce_remove_wishlist($wishlist_id);
    }

    public function cms_ecommerce_gallery($category=NULL)
    {
        return $this->No_CMS_Model->cms_ecommerce_gallery($category);
    }

    public function cms_ecommerce_gallery_info($id)
    {
        return $this->No_CMS_Model->cms_ecommerce_gallery_info($id);
    }

    public function check_order_exist($user_id)
    {
        return $this->No_CMS_Model->check_order_exist($user_id);
    }

    public function cms_do_confirm_payment($order_no,$user_id,$data)
    {
        return $this->No_CMS_Model->do_confirm_payment($order_no,$user_id,$data);
    }

    public function get_available_product_category()
    {
        return $this->No_CMS_Model->get_available_product_category();
    }

    public function cms_get_testimonial($limit=NULL)
    {
        return $this->No_CMS_Model->cms_get_testimonial($limit);   
    }

    public function cms_get_product_category()
    {
        return $this->No_CMS_Model->cms_get_product_category();   
    }

    public function cms_find_city($keyword){
        return $this->No_CMS_Model->find_city($keyword);
    }

    public function cms_ecommerce_shipping($city)
    {
        return $this->No_CMS_Model->cms_ecommerce_shipping($city);
    }
}
