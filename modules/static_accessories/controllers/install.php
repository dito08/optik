...
class Install extends CMS_Module_Installer {
    ...
    private function remove_all(){
        ...
        // remove widgets
        $this->remove_widget($this->cms_complete_navigation_name('category'));
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('manage_category'), 'Category',
        ...
        $this->add_widget($this->cms_complete_navigation_name('category'), 'Category',
            $this->PRIV_EVERYONE, $module_path.'/static_accessories_widget/category');
        ...
        $fields = array(
            ...
            'url_page'=> array("type"=>'varchar', "constraint"=>100, "null"=>TRUE),
