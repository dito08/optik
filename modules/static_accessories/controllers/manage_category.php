...
class Manage_Category extends CMS_Priv_Strict_Controller {
	...
	public function index(){
        ...
        $crud->columns('image_url','title','url_page','content');
        // displayed columns on edit operation
        $crud->edit_fields('image_url','title','url_page','content');
        // displayed columns on add operation
        $crud->add_fields('image_url','title','url_page','content');

        // caption of each columns
        $crud->display_as('title','Title Category');
        $crud->display_as('image_url','Image Url');
        $crud->display_as('url_page','Url Page Direction');
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $crud->set_field_upload('image_url','modules/'.$this->cms_module_path().'/assets/images/category');
