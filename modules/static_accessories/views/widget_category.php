...
for($i=0; $i<count($category_list); $i++){
    ...
    $div_item_list[] = 
            ...
            '<img class="category-image" src="'.base_url('modules/'.$module_path.'/assets/images/category/'.$category['image_url']).'" alt="">'.
            '<div class="mask">'.
			'<p>'.$category['content'].'</p>'.
			'<a href="'.base_url().$category['url_page'].'" class="info">View</a>'.
			'</div>'.
            '</div></div></div></div>';
}
?>
