...
<div id="record_content" class="blog">
    <?php
        if(isset($article) && $article !== FALSE){
            ...
            foreach($article['photos'] as $photo){
                ...
                echo '<img class="img-responsive" style="margin-bottom:100px;" src="'.base_url('modules/{{ module_path }}/assets/uploads/'.$photo['url']).'" />';
                echo '</a>';
                echo '</div>';
            }
            echo '</div>';
