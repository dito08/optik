...
class Blog extends CMS_Priv_Strict_Controller {
    ...
    public function index($article_url = NULL){
        ...
        //$encoded_category = urldecode($this->input->get('category'));
        $encoded_category = $name2 = str_replace("%20"," ",$this->input->get('category'));
        ...
        $data = array(
            ...
            'chosen_category'        => $encoded_category,
        ...
        //var_dump($data['chosen_category']);die();
        $config = array();
