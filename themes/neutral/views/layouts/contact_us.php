...
<html lang="{{ language:language_alias }}">
    ...
    <body>
        ...
        <div class="container">
            <div class="row-fluid">
                <div>     
                    <div id="__section-left-and-content" class="col-md-8">
                        <div id="__section-content" class="col-md-12"><?php echo $template['body'];?>
                        </div>
                        <div class="col-md-12">
                            {{ widget_name:contact_forms }}
                        </div>
                    </div><!--/#layout-content-->
                    <div id="__section-right" class="col-md-4" style="padding:15px;">
                        {{ widget_name:static_address }}
                    </div><!--/#layout-widget-->
                </div>
            </div><!--/row-->
        </div><!--/.fluid-container-->
